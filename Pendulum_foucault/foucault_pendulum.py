...
dt = 0.15  # [s]     -  pas de temps
Tend = 150.  # [s]     -  fin de la simulation
...
def see_animation(save=""):
    ...
    anim = FuncAnimation(fig, update, n // ratio, interval=5, blit=(save != "gif"), init_func=init, repeat_delay=3000)

    if save == "save":
        anim.save('Foucault_2.html', fps=fps)
    elif save == "gif":
